...
void main() {
  ...
  testWidgets(
    ...
    (widgetTester) async {
      ...
      expect(
        widgetTester.widget<TextFormField>(find.byKey(keyMemName)).initialValue,
        insertedMemName,
      );
      expect(find.text(insertedMemName), findsOneWidget);
      expect(
        widgetTester.widget<TextFormField>(find.byKey(keyMemMemo)).initialValue,
        insertedMemMemo,
      );
      ...
      testWidgets(
        ...
        (widgetTester) async {
          ...
          expect(find.text(l10n.saveMemSuccessMessage(enteringMemName)),
              findsOneWidget);
          final getCreatedMem = Equals(defColMemsName.name, enteringMemName);
    ...
    () {
      ...
      testWidgets(
        ...
        (widgetTester) async {
          ...
          expect((await selectFromMemsWhereName(insertedMemName)).length, 0);
        },
      );
      ...
      testWidgets(
        ...
        (widgetTester) async {
          ...
          expect(find.text(insertedMemName), findsOneWidget);
          expect((await selectFromMemsWhereName(insertedMemName)).length, 1);
